...
useless = ['diff1-2', 'precipitation_amt_mm', 'month_sin', 'last3WeekAverage', 'station_min_temp_c', 'diff2-3', 'reanalysis_max_air_temp_k', 'last_year_cases', 'week_cos', 'month_cos', 'reanalysis_sat_precip_amt_mm', '3w', 'station_precip_mm', 'station_max_temp_c', 'ndvi_se', 'reanalysis_min_air_temp_k', '1w', '2w']
...
plt.legend()
plt.savefig('(2,0,2)(1,0,1,52)[all without ablationUseless]')
